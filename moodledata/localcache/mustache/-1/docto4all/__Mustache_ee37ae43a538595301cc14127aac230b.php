...
class __Mustache_ee37ae43a538595301cc14127aac230b extends Mustache_Template
{
...
';
        $buffer .= $indent . '    
';
        $value = $context->find('showcourseindexnav');
        $buffer .= $this->sectionEfb379de05738abde69532363f68b9d2($context, $indent, $value);
        $value = $context->find('showblockdrawer');
        $buffer .= $this->section68d69903b1e5372722e76fa2696055f1($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '    
';
...
';
        ...
        $value = $context->find('showcourseindexnav');
        $buffer .= $this->sectionB34571cb109f97cdc87d5a70e3aa90d5($context, $indent, $value);
        $value = $context->find('showblockdrawer');
        $buffer .= $this->sectionEe066bf8165c732bf0917149d1b8f4e3($context, $indent, $value);
...
';
        $buffer .= $indent . '        ';
        $value = $this->resolveValue($context->findDot('output.top_activity_navigation'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        if ($partial = $this->mustache->loadPartial('theme_learnr/navbar')) {
...
';
        $value = $context->find('showcourseindexnav');
        $buffer .= $this->section6248271a394a894a9a676691b47cf8b2($context, $indent, $value);
        $value = $context->find('showblockdrawer');
        $buffer .= $this->section194106d940a1d85fc67e3dc8e3ccc8c2($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= $indent . '            ';
        $value = $this->resolveValue($context->findDot('output.courseprogressbar'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
...
';
        ...
        $buffer .= $this->section9f4d75a572fdd54740897938d84c018e($context, $indent, $value);
        $value = $context->find('fptextbox');
        $buffer .= $this->sectionC29c1f6a849385db5416e644465b8fca($context, $indent, $value);
        $value = $context->find('hasregionmainsettingsmenu');
...
';
        ...
        $buffer .= '
';
        $value = $context->find('displayfooterblocks');
        $buffer .= $this->sectionD78edc97b121e6c221392a5892c736e5($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionEfb379de05738abde69532363f68b9d2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section68d69903b1e5372722e76fa2696055f1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionB34571cb109f97cdc87d5a70e3aa90d5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{#courseindexopen}}show-drawer-left{{/courseindexopen}} ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
    ...
    private function sectionEe066bf8165c732bf0917149d1b8f4e3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{#blockdraweropen}}show-drawer-right{{/blockdraweropen}}';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
...
';
    ...
    private function section6248271a394a894a9a676691b47cf8b2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section194106d940a1d85fc67e3dc8e3ccc8c2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9f4d75a572fdd54740897938d84c018e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <div class="alertbox card-body">
                                <div class="alertmessage card-text alert alert-warning">
                                {{{ alertbox }}}
                                </div>
                            </div>
                        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            <div class="alertbox card-body">
';
                $buffer .= $indent . '                                <div class="alertmessage card-text alert alert-warning">
';
                $buffer .= $indent . '                                ';
...
';
    ...
    private function sectionC29c1f6a849385db5416e644465b8fca(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <div class="fptextbox card-body">
                                <div class="card-text">
                                    {{{ fptextbox }}}
                                </div>
                            </div>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            <div class="fptextbox card-body">
';
...
';
    ...
    private function sectionEdf387d8939848b9c3f67a16e4dcdb39(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
            <div class="container-fluid footerblocks">
                    <div class="fp-blocks">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-4">
                                        <section data-region="blocks-footera" class="hidden-print">
                                            {{{ footerabtn }}}
                                            {{{ footeraregion }}}
                                        </section>
                                </div>
                                <div class="col-md-4">
                                        <section data-region="blocks-footerb" class="hidden-print">
                                            {{{ footerbbtn }}}
                                            {{{ footerbregion }}}
                                        </section>
                                </div>
                                <div class="col-md-4">
                                        <section data-region="blocks-footerc" class="hidden-print">
                                            {{{ footercbtn }}}
                                            {{{ footercregion }}}
                                        </section>
                                </div>
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            <div class="container-fluid footerblocks">
';
...
';
                $buffer .= $indent . '                                        <section data-region="blocks-footera" class="hidden-print">
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('footerabtn'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('footeraregion'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '                                        </section>
...
';
                $buffer .= $indent . '                                <div class="col-md-4">
';
                $buffer .= $indent . '                                        <section data-region="blocks-footerb" class="hidden-print">
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('footerbbtn'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('footerbregion'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '                                        </section>
...
';
                $buffer .= $indent . '                                <div class="col-md-4">
';
                $buffer .= $indent . '                                        <section data-region="blocks-footerc" class="hidden-print">
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('footercbtn'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '                                            ';
                $value = $this->resolveValue($context->find('footercregion'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '                                        </section>
...
';
    ...
    private function sectionD78edc97b121e6c221392a5892c736e5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $context->find('hasfooterblocks');
                $buffer .= $this->sectionEdf387d8939848b9c3f67a16e4dcdb39($context, $indent, $value);
                $context->pop();
            }
        }
