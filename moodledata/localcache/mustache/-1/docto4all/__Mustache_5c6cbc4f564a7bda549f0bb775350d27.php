...
class __Mustache_5c6cbc4f564a7bda549f0bb775350d27 extends Mustache_Template
{
...
';
        ...
        $value = $context->find('showblockdrawer');
        $buffer .= $this->sectionC87032039c06844651454b3824ca1230($context, $indent, $value);
...
';
        $buffer .= $indent . '            ';
        $value = $this->resolveValue($context->findDot('output.fpicons'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '            ';
...
';
        ...
        $value = $context->find('showblockdrawer');
        $buffer .= $this->sectionB485ee947f17ec40d4815f752062d402($context, $indent, $value);
        $value = $context->find('showblockdrawer');
        if (empty($value)) {
...
';
            $buffer .= $indent . '                            ';
            $value = $this->resolveValue($context->findDot('output.enrolform'), $context);
            $buffer .= ($value === null ? '' : $value);
            $buffer .= '
';
            $buffer .= $indent . '                              ';
...
';
            ...
            $buffer .= $this->sectionB3210a0bf5dd4401e66f639a006f5a02($context, $indent, $value);
            $buffer .= $indent . '                          </div>
';
            $buffer .= $indent . '                        </div>
';
...
';
        $value = $context->find('hasmarketingtiles');
        $buffer .= $this->sectionA20deb0c68fc87f05a84c33e5149285f($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function sectionC87032039c06844651454b3824ca1230(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB485ee947f17ec40d4815f752062d402(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB3210a0bf5dd4401e66f639a006f5a02(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA20deb0c68fc87f05a84c33e5149285f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
