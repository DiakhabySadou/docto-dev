...
class __Mustache_4920b8949b552c642876b1af5f219f1d extends Mustache_Template
{
...
';
        $buffer .= $indent . '        </label>
';
        $buffer .= $indent . '        <div class="edit-btn custom-control custom-switch">
';
        $buffer .= $indent . '            <input type="checkbox"';
        $buffer .= ' name="setmode"';
        $value = $context->find('checked');
        $buffer .= $this->sectionDef90bb46e8ce7acd6eec4265d38a4aa($context, $indent, $value);
        $value = $context->find('checked');
        if (empty($value)) {
...
';
    ...
    private function sectionDef90bb46e8ce7acd6eec4265d38a4aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
