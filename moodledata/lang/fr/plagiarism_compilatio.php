...
/**
 * Strings for component 'plagiarism_compilatio', language 'fr', version '4.0'.
 *
...
$string['migration_support'] = '<p>Si tous les documents n\'ont pas été mis à jour correctement, veuillez contacter l\'équipe support Compilatio à support@compilatio.net et spécifiez :</p>
    <p><<
        <br>
        Une erreur s\'est produite lors de la mise à jour des données de v4 vers v5 d\'une plateforme Moodle de notre établissement
        <ul>
            <li>Le message d\'erreur suivant est apparu : [message]</li>
            <li>[nom_établissement]</li>
            <li>[Nom instance Moodle, si plusieurs instances utilisées]</li>
            <li>Clé API v4 : [____]</li>
            <li>Clé API v5 : [____]</li>
            <li>Nom de la personne contact de l\'institution :</li>
            <li>Courriel de la personne contact :</li>
            <li>Téléphone de la personne contact :</li>
        </ul>
    >><p>';
...
$string['privacy:metadata:plagiarism_compilatio_files:errorresponse'] = 'La réponse si une erreur s\'est produite - en fait, ce champ n\'est plus utilisé et prend automatiquement la valeur "NULL".';
